define(['angular'], function(angular){
    ...
    utilServices.factory('editarCotizacion', [
        function(){
            return {};
        }
    ]);

	utilServices.factory('nrosolic', [
        function(){
            return {};
        }
    ]);
	...
	return {
      ...
      // TODO: Para enviar documento
      enviarDocumento: function(nombre, uri) {
		$modal.open({
		    templateUrl: 'views/mensaje/enviarCotizacion.html',
		    controller:'enviarDocumentoCtr',
		    backdrop: 'static',
		    resolve: {
			nombre: function () {
			    return nombre;
