 ...
 *
 */
public class JdbcObtenerCodigoIntermediarioSP extends StoredProcedure {
	
	public static final String SP_NAME = "acsel.pr_web_auto.devuelve_codinter";
	public static final String COD_INTERMEDIARIO = "cod_usuario";
	 ...
	 * @param ds
	 */
	public JdbcObtenerCodigoIntermediarioSP(DataSource ds) {		
		super(ds, SP_NAME);
		declareParameter(new SqlOutParameter(COD_INTERMEDIARIO, Types.VARCHAR));
